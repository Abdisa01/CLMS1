...
<head>
    ...
    <body>
          ...
          <header id="header" class="clearfix">
               ...
               Welcome to Technical Assistant page </a>
               ...
               <section id="content" class="container">
			    <header class="p-header">
				   ...
				   <?php
								  ...
								  $typee="All";
                                  $querys = mysql_query("SELECT * FROM news WHERE Status='$type' OR Status='$typee' AND st='posted' ORDER BY date DESC ")or die(mysql_error()); 
								  $array = array();
