        ...
        <section id="main" role="main">
            ...
            <section  style="width:84.5%;"id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">Update computer Information List</h2>
                </header>
                ...
                <div class="table-responsive">
					...
					$count = "SELECT * FROM user WHERE username='$session_id'";
									     ...
									     $data=mysql_fetch_array($answer);
									         //$id =$data["bn"];
					$user_query=mysql_query("select * from computer  ")or die(mysql_error());
									while($row=mysql_fetch_array($user_query)){
									$id=$row['comp_id']; ?>		
							<td><?php echo $row['comp_name']; ?></td>
						   <td><?php echo $row['comp_type']; ?></td>
						   <td><?php echo $row['comp_model']; ?></td>
						    <th><?php echo $row['comp_serial']; ?></th>
						   <td>0<?php echo $row['lab_name']; ?></td>
						   <td><?php echo $row['lab_number']; ?></td>
						   <td><?php echo $row['AMU_code']; ?></td>
						   <td><?php echo $row['status']; ?></td>  
						
							<td class="center">
							
							<a class=" btn btn-success" data-toggle="modal" href="edit_computer.php?id=<?php echo $id;?>" data-target="#form-modal">Update</a>
