        ...
        <section id="main" role="main">
            ...
            <section id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title" style="color:#e60e18;">Add computer record Panel</h2>
...
$error=0;
	if(isset($_POST['add_computer'])){
								...
								$query = "insert into computer (comp_name,comp_type,comp_model,comp_serial,lab_name,lab_number,AMU_code,status) values('$cn','$ct','$cm','$cs','$ln','$lno','$ac','$status')";
								$result = mysql_query($query)or die(mysql_error());
								if( $result==1){
								echo '<div class="alert alert-dismissable alert-success">';
								echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
								echo '<strong>'.'<center>'."Computer record is Add successfully !".'</center>'.'</strong>';
								echo "<script>windows: location='add_computer.php'</script>";
								echo '</div>';
								}
								else{
					...
					<div class="form-group">
						...
						<button class="ladda-button ladda-button-demo btn btn-primary" type="submit" name="add_computer">Add computer</button>
