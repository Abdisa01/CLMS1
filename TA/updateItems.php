        ...
        <section id="main" role="main">
            ...
            <section  style="width:84.5%;"id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">Update Item Record Information List</h2>
                </header>
                ...
                <div class="table-responsive">
					...
					$count = "SELECT * FROM user WHERE username='$session_id'";
									     ...
									     $data=mysql_fetch_array($answer);
									       //  $to =$data["bn"];
					$user_query=mysql_query("select * item  ")or die(mysql_error());
									while($row=mysql_fetch_array($user_query)){
									$id=$row['item_id']; ?>		
							<td><?php echo $row['item_name']; ?></td>
						   <td><?php echo $row['item_type']; ?></td>
						   <td><?php echo $row['item_model']; ?></td>
						    <th><?php echo $row['item_serial'];?></th>
						   ...
						   <td><?php echo $row['status']; ?></td>  
							...
							<a class=" btn btn-success" data-toggle="modal" href="edit_items.php?id=<?php echo $id;?>" data-target="#form-modal">Update</a>
