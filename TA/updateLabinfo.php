        ...
        <section id="main" role="main">
            ...
            <section  style="width:84.5%;"id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">Update Laboratory Information Lists</h2>
                </header>
                ...
                <div class="table-responsive">
					...
					$user_query=mysql_query("select * from laboratory ")or die(mysql_error());
						   ...
						   <td><?php echo $row['lab_type']; ?></td>
						    <th><?php echo $row['lab_location']; ?></th>
						   ...
						   <td><?php echo $row['accomendation']; ?></td>
							...
							<a class=" btn btn-success" data-toggle="modal" href="edit_labinfo.php?id=<?php echo $id;?>" data-target="#form-modal">Update</a>
