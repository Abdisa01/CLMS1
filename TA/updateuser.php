        ...
        <section id="main" role="main">
            ...
            <section style="width:84.5%;" id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">View User Account List Updation Area!</h2>
                </header>
                ...
                <div class="table-responsive">
						 ...
						 <td><?php echo $row['ln']; ?></td>
						  ...
						  <td><?php echo $row['bn']; ?></td>
						   ...
						   <td><?php echo $row['user_type']; ?></td>
						    <td> <?php echo "<img width='40' height='40' class='img-circle profile_img' src='image/".$row['image']." ' alt='profile pic'>";?></td>
							
							<td class="center">
							
							<a class=" btn btn-primary" data-toggle="modal" href="edit_user.php?id=<?php echo $id;?>" data-target="#form-modal">Update</a>
                    ...
                    <p><a data-toggle="modal" href="#form-modal"></a></p>
