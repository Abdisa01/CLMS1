        ...
        <section id="main" role="main">
            ...
            <section  style="width:84.5%;"id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">Delete Victim Information Person list</h2>
                </header>
                ...
                <div class="table-responsive">
					...
					$count = "SELECT * FROM Account WHERE username='$session_id'";
									     ...
									     $data=mysql_fetch_array($answer);
									         $to =$data["bn"];
					$user_query=mysql_query("select * from victims_information where sender_branch='$to'  ")or die(mysql_error());
						   ...
						   <td><?php echo $row['ki']; ?></td>
						   <td><?php echo $row['edu_status']; ?></td>
						   <td><?php echo $row['job']; ?></td>  
						   <td><?php echo $row['religion']; ?></td>
						   
						<td><?php  echo "<img width='40' height='40' class='img-circle profile_img' src='../images/".$row['image']." ' alt='profile pic'>";
				 ?></td>
                      
					  	
							<td class="center">
							
							<a class=" btn btn-danger" data-toggle="modal" href="confirm_victims.php?id=<?php echo $id;?>" data-target="#form-modal">Delete</a>
