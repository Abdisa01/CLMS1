...
<head>
  ...
  <section id="content" class="container">
	  ...
	  $get_id = $_GET['id']; ?>
<?php 
		$query=mysql_query("select * from accused where aid='$get_id'")or die(mysql_error());
		$row=mysql_fetch_array($query);
		$id=$row['aid'];
		?>
	                <div class="modal-header" style="width:100%;">
					                <button type="button" style="color:red;" class="close" ><a STYLE="COLOR:RED;margin-left:150px;" class="icon-close"   aria-hidden="true" href="deleteaccused.php">   </a></button>
                                    <!--<button class="close" type="button" data-dismiss="modal" aria-hidden="true"></button>-->
                                    <h4 class="modal-title"style="color:red;margin-left:75px;"><center  >Are you sure you want to delete Selected Accused? </center></h4>
                                </div>
            <div class="modal-body" style="width:100%;">
                ...
                <!-- Required Feilds -->
                    ...
                    <form    role="form" action="delete_accused.php"  method="GET" enctype="multipart/form-data"  onsubmit="return check_info();">
					  ...
					  <div class="form-group">
                        ...
                        <div class="form-group">
						  ...
						  <div class="modal-footer" >
                                    ...
                                    <button type="button" class="btn btn-lg btn-success"><a style="color:white;"href="deleteaccused.php">No</a></button>
                                </div>
                        </form>
