...
$error=0;
	if(isset($_POST['Create'])){
                                ...
                                $query = "insert into user(f_name,l_name,gender,usertype,organization,username,password,email,phone,p_picture) values('$fn','$ln','$gender','$user_type','$email_id','$pn','$password','$username','$organization','$image_name')";
