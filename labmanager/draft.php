               ...
               <section id="content" class="container">
                         ...
                         <div class="dropdown pull-left compose-message">
                              ...
                              <div class="dropdown-menu dropdown-form flat" role="menu">
                                   ...
                                   <div class="flat-body">  
										...
										<div class="form-group">
                                            <input type="file" class="form-control input-sm" placeholder="Subject">
                                        </div>
                                   </div>
                    ...
                    <div class="block">
                         <div class="media messages">
                              <div class="pull-left message-menu">
                                   ...
                                   <div class="list-group">
								        ...
								        $da=mysql_fetch_array($ans);
									         $to_email =$da["email"];
											 $sta="Draft";
									$ab = mysql_query("SELECT * FROM Mail WHERE send_from='$to_email' AND status_from='$sta'"); 
										  $X=0;
							...
							?>
							<?php echo $X ?></span></a>
                                        <a href="draft.php" class="list-group-item active">Drafts <span class="badge"><?php
							...
							<?php echo $Z ?></span></a>
                                   ...
                                   <div class="list-group">
                                        <a href="trash.php" class="list-group-item">Trash <span class="badge" style="color:red"><?php
							            $answer = mysql_query( "SELECT * FROM user WHERE username='$session_id'")or die(mysql_error());
								        $data=mysql_fetch_array($answer);
									         $to =$data["email"];
											 $stat="Deleted";
                                   ...
                                   <div class="listview">
                                        <header class="media listview-header">
                                             ...
                                             <span class="pull-right message-pagin">
                                                  <a href="#" class="icon-angle-left"></a>
