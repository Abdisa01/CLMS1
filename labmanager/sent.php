                    ...
                    <div class="block">
                         <div class="media messages">
							...
							<?php echo $X ?></span></a>
                                        ...
                                        <a href="sent.php" class="list-group-item active">Sent Mail <span class="badge"><?php
                                   ...
                                   <div class="listview">
										...
										<?php 
									     ...
									     $row=mysql_fetch_array($result);
									         $e_mail =$row["email"];
											 $stata="Sent";
                                          $querys = mysql_query("SELECT * FROM Mail WHERE send_from='$e_mail' AND status_from='$stata'"); 
								          $array = array();
