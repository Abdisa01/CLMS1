...
<head>
  ...
  <section id="content" class="container">
	  ...
	  $get_id = $_GET['id']; ?>
<?php 
		$query=mysql_query("select * from feedback where id='$get_id'")or die(mysql_error());
		$row=mysql_fetch_array($query);
		$id=$row['id'];
		?>
	                <div class="modal-header" style="width:100%;">
					                <button type="button" style="color:red;" class="close" ><a STYLE="COLOR:RED;margin-left:150px;" class="icon-close"   aria-hidden="true" href="view_feedback.php">   </a></button>
                                    <!--<button class="close" type="button" data-dismiss="modal" aria-hidden="true"></button>-->
                                    <h4 class="modal-title"style="color:red;margin-left:74px;font-family:times new roman;font-size:13px;"><center  >Are you sure you want to delete? </center></h4>
                                </div>
            <div class="modal-body" style="width:100%;">
                ...
                <!-- Required Feilds -->
                    ...
                    <form    role="form" action="delete_feedback.php"  method="GET" enctype="multipart/form-data" >
					  <input type="hidden" name="id"  value="<?php echo $get_id ?>"   />
                            <div class="form-group">
                            <strong> <label style="color:red;">Full Name :</label></strong>
							 <?php echo $row['name']; ?><br>
							 </div>
                            <div class="form-group">
                           <strong> <label style="color:red;">Email Address :</label></strong>
                             <?php echo $row['email']; ?><br>
							 </div>
                       
						  <div class="modal-footer" >
                                    <input type="Submit" style="margin-left:-100px;"name="delete" value="Yes "class="btn btn-lg btn-danger">
                                    <button type="button" class="btn btn-lg btn-success"><a style="color:white;"href="view_feedback.php">No</a></button>
                                </div>
                        </form>
