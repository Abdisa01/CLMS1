        ...
        <section id="main" role="main">
            ...
            <section  style="width:84.5%;padding:30px;"id="content" class="container">
                <header class="p-header">
                    <h2 class="p-title">View User Account List to delete</h2>
                </header>
					...
					<?php $user_query=mysql_query("select * from user")or die(mysql_error());
                        ...
                        <td><?php echo $row['f_name']; ?></td>
						 <td><?php echo $row['l_name']; ?></td>
						  ...
						  <th><?php echo $row['organization']; ?></th>
						  <td><?php echo $row['phone']; ?></td>
						   <td><?php echo $row['email']; ?></td>
						   <td><?php echo $row['usertype']; ?></td>
						    <td> <?php echo "<img width='40' height='40' class='img-circle profile_img' src='image/".$row['p_picture']." ' alt='profile pic'>";?></td>
							 	 
							 <td class="center">
							
							<a class=" btn btn-danger" data-toggle="modal" href="confirm_user.php?id=<?php echo $id;?>" data-target="#form-modal">Delete</a>
									</td></tr><?php }?>
